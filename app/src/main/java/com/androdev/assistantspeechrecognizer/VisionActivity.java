...
public class VisionActivity extends Activity implements AdapterView.OnItemSelectedListener {

    private static final String TAG = "MainActivity";
    private static final int RECORD_REQUEST_CODE = 101;
    private static final int CAMERA_REQUEST_CODE = 102;

    private static final String CLOUD_VISION_API_KEY = "AIzaSyBwR8uwt7doops0ekipKNh8EHfJVisE0Zc";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        visionAPIData = findViewById(R.id.textView);
        spinnerVisionAPI = findViewById(R.id.spinner);
